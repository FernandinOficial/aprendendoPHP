...
<div class="container">
    ...
    if (isset($_POST['update'])) {
        if (empty($_POST['firstname']) || empty($_POST['lastname']) || empty($_POST['address']) || empty($_POST['contact'])) {
            ...
            $sql = "UPDATE users SET firstname = '{$firstname}', lastname = '{$lastname}', address = '{$address}', contact = '{$contact}' WHERE user_id =" . $_POST['user_id'];
    ...
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="box">
                ...
                <form action="" method="POST">  <!-- Formulário -->
                    <input type="hidden" value="<?php echo $row['user_id'];?>" name="user_id"><br>
